...
if __name__ == '__main__':
    ...
    sched.add_job(bot_main, 'cron', ['get_waiver_report'], id='waiver_report',
                  day_of_week='mon, tue, wed, thu, fri, sat, sun', hour=12, minute=2, start_date=ff_start_date, end_date=ff_end_date,
                  timezone=my_timezone, replace_existing=True)
    ...
    sched.add_job(bot_main, 'cron', ['get_proj_distr'], id='proj_distr',
                  day_of_week='tue', hour=11, minute=0, start_date=ff_start_date, end_date=ff_end_date,
                  timezone=game_timezone, replace_existing=True)
